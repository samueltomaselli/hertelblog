...
function Posts({ author, createdAt, subtitle, title, urlImage, urlPhoto, slug }: PostProps) {
  return (
    <Link
      href={`blog/post/${slug}`}
      className="w-full sm:max-w-[350px] h-full flex flex-col items-center justify-between gap-2 sm:gap-4 rounded-t-2xl hover:scale-95 transition-all duration-300 hover:brightness-75"
    >
      ...
      <div className="flex w-full flex-1 flex-col justify-between gap-2 sm:gap-4">
